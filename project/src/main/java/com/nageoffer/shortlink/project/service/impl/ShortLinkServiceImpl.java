...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public ShortLinkSaveRespDTO createShortLink(ShortLinkSaveReqDTO saveReqDTO) {
        ...
        ShortLinkDO shortLinkDO = ShortLinkDO.builder()
                ...
                .createType(saveReqDTO.getCreateType())
                .validDateType(saveReqDTO.getValidDateType())
                .validDate(saveReqDTO.getValidDate())
                ...
                .favicon(getFaviconUrl(saveReqDTO.getOriginUrl()))
                .build();
    ...
    public IPage<ShortLinkPageRespDTO> pageShortLink(ShortLinkPageReqDTO pageReqDTO) {
        IPage<ShortLinkDO> resultPage = baseMapper.pageLink(pageReqDTO);
    ...
    public ShortLinkBatchCreateRespDTO batchCreateShortLink(ShortLinkBatchCreateReqDTO requestParam) {
        ...
        for (int i = 0; i < originUrls.size(); i++) {
            ShortLinkSaveReqDTO shortLinkSaveReqDTO = BeanUtil.toBean(requestParam, ShortLinkSaveReqDTO.class);
            shortLinkSaveReqDTO.setOriginUrl(originUrls.get(i));
            shortLinkSaveReqDTO.setDescription(describes.get(i));
            try {
                ShortLinkSaveRespDTO shortLink = createShortLink(shortLinkSaveReqDTO);
